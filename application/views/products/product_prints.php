    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div id="product_main_img_1" class="div-sec similar_banner" tabIndex=1 title="bg_img"
                style="background-size: 100%; background-position: center;background-image: url(<?= base_url((isset($page_data[1]->bg_img) ? $page_data[1]->bg_img : 'assets/images/ipad_pro_hero__c60u09fxbrsm_large.jpg')); ?>);">
                <div class="container">
                    <div class="row">
        ...
        <div class="row">
            <div id="product_main_img_2" class="div-sec similar_banner" tabIndex=2 title="bg_img"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a
                                href="<?= isset($page_data[2]->link_url) ? $page_data[2]->link_url : '/home/listing' ?>"><?= isset($page_data[2]->link_label) ? $page_data[2]->link_label : 'Learn more ' ?><i
                                    class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </div>
        ...
        <div class="row">
            <div id="product_main_img_2" class="div-sec similar_banner" tabIndex=3 title="bg_img"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a
                                href="<?= isset($page_data[3]->link_url) ? $page_data[3]->link_url : '/home/listing' ?>"><?= isset($page_data[3]->link_label) ? $page_data[3]->link_label : 'Learn more ' ?><i
                                    class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </div>
                        <div class="col-md-8"></div>
                    </div>
        ...
        <div class="row">
            <div id="product_main_img_2" class="div-sec similar_banner" tabIndex=4 title="bg_img"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3" style="padding-top: 110px">
                            ...
                            <a
                                href="<?= isset($page_data[4]->link_url) ? $page_data[4]->link_url : '/home/listing' ?>"><?= isset($page_data[4]->link_label) ? $page_data[4]->link_label : 'Learn more ' ?><i
                                    class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="compare_models" style="margin: 0px 15px">
                    ...
                    <div style="padding: 0 380px;text-align: center;" class="responsive_padding">
                        ...
                        <a
                            href="<?= isset($page_data[6]->link_url) ? $page_data[6]->link_url : '/home/listing' ?>"><?= isset($page_data[6]->link_label) ? $page_data[6]->link_label : 'Find your trade‑in value ' ?><i
                                class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="padding: 60px 0">
            <div class="col-md-4">
                <div style="text-align: center;padding: 0 50px">
                    ...
                    <a
                        href="<?= isset($page_data[7]->link_url1) ? $page_data[7]->link_url1 : '/home/listing' ?>"><?= isset($page_data[7]->link_label1) ? $page_data[7]->link_label1 : 'Learn more ' ?>
            ...
            <div class="col-md-4">
                <div style="text-align: center;padding: 0 55px">
                    ...
                    <a
                        href="<?= isset($page_data[7]->link_url2) ? $page_data[7]->link_url2 : '/home/listing' ?>"><?= isset($page_data[7]->link_label2) ? $page_data[7]->link_label2 : 'Learn more ' ?>
                        <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                </div>
            </div>
            <div class="col-md-4">
                <div style="text-align: center;padding: 0 65px">
                    ...
                    <a
                        href="<?= isset($page_data[7]->link_url3) ? $page_data[7]->link_url3 : '/home/listing' ?>"><?= isset($page_data[7]->link_label3) ? $page_data[7]->link_label3 : 'Learn more ' ?>
                        <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin: 0px 0;">
            <div class="col-md-6 leftBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes" tabIndex=9 title="bg_img"
                    ...
                    <div style="margin: 0 auto;">
                        ...
                        <a
                            href="<?= isset($page_data[9]->link2_url) ? $page_data[9]->link2_url : '/home/listing' ?>"><?= isset($page_data[9]->link2_label) ? $page_data[9]->link2_label : 'Buy ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 rightBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes" tabIndex=10 title="bg_img"
                    ...
                    <div style="margin: 0 auto;">
                        ...
                        <a href="<?= isset($page_data[10]->link1_url) ? $page_data[10]->link1_url : '/home/listing' ?>"
                            ...
                            <i class="fa fa-angle-right"></i></a>
                        <a
                            href="<?= isset($page_data[10]->link2_url) ? $page_data[10]->link2_url : '/home/listing' ?>"><?= isset($page_data[10]->link2_label) ? $page_data[10]->link2_label : 'Buy ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin: 8px 0;">
            <div class="col-md-6 leftBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes btm-text" tabIndex=11 title="bg_img"
            ...
            <div class="col-md-6 rightBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes btm-text" tabIndex=12 title="bg_img"
        ...
        <div class="row" style="margin: 27px 0;">
            <div class="col-md-12" style="padding: 0">
                <div class="home_sections_bg3 div-sec similar_banner" tabIndex=14 title="bg_img"
        ...
        <div class="row" style="margin: 27px 0;">
            <div class="col-md-12" style="padding:0">
                <div class="home_sections_bg3 div-sec similar_banner" tabIndex=15 title="bg_img"
        ...
        <div class="row" style="margin: 27px 0;">
            <div class="col-md-6 leftBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes" tabIndex=16 title="bg_img"
                    ...
                    <div style="margin: 0 auto" class="responsive_width">
                        ...
                        <a
                            href="<?= isset($page_data[16]->link1_url) ? $page_data[16]->link1_url : '/home/listing' ?>"><?= isset($page_data[16]->link1_label) ? $page_data[16]->link1_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                        <a
                            href="<?= isset($page_data[16]->link2_url) ? $page_data[16]->link2_url : '/home/listing' ?>"><?= isset($page_data[16]->link2_label) ? $page_data[16]->link2_label : 'Buy ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 rightBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes" tabIndex=17 title="bg_img"
                    ...
                    <div style="margin: 0 auto" class="responsive_width">
                        ...
                        <p><?= isset($page_data[17]->sub_heading) ? $page_data[17]->sub_heading : 'Cashless made effortless.' ?>
                        </p>
                        <a
                            href="<?= isset($page_data[17]->link1_url) ? $page_data[17]->link1_url : '/home/listing' ?>"><?= isset($page_data[17]->link1_label) ? $page_data[17]->link1_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                        <a
                            href="<?= isset($page_data[17]->link2_url) ? $page_data[17]->link2_url : '/home/listing' ?>"><?= isset($page_data[17]->link2_label) ? $page_data[17]->link2_label : 'Buy ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
        ...
        <div class="row" style="margin: 15px 0;">
            <div class="col-md-12" style="padding: 0">
                <div class="home_sections_bg4 div-sec similar_banner" tabIndex=19 title="bg_img"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="text-align: center">
                            ...
                            <p><?= isset($page_data[19]->sub_heading) ? $page_data[19]->sub_heading : 'Lights. Camera. iPad. <br>Every new iPad comes with one year of Apple TV+.' ?>
                            </p>
                            <a class="padding-applied"
        ...
        <div class="row" style="margin: 8px 0;">
            <div class="col-md-6 leftBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes" tabIndex=20 title="bg_img"
                    ...
                    <div style="margin: 0 auto" class="responsive_width">
                        ...
                        <p><?= isset($page_data[20]->sub_heading) ? $page_data[20]->sub_heading : 'Get 3% Daily Cash back on purchases from Apple using Apple Card.' ?>
                        </p>
                        <a
                            href="<?= isset($page_data[20]->link1_url) ? $page_data[20]->link1_url : '/home/listing' ?>"><?= isset($page_data[20]->link1_label) ? $page_data[20]->link1_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                        <a
            ...
            <div class="col-md-6 rightBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes" tabIndex=21 title="bg_img"
        ...
        <div class="row" style="margin: 8px 0;">
            <div class="col-md-6 leftBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes btm-text" tabIndex=22 title="bg_img"
                    ...
                    <div style="margin: 0 auto" class="responsive_width">
                        ...
                        <a href="<?= isset($page_data[22]->link1_url) ? $page_data[22]->link1_url : '/home/listing' ?>"
                            ...
                            <i class="fa fa-angle-right"></i></a>
                        <a
                            href="<?= isset($page_data[22]->link2_url) ? $page_data[22]->link2_url : '/home/listing' ?>"><?= isset($page_data[22]->link2_label) ? $page_data[22]->link2_label : 'Buy ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 rightBox px-md-2">
                <div class="home_sections_bg1 div-sec similar_boxes btm-text" tabIndex=23 title="bg_img"
                    ...
                    <div style="margin: 0 auto" class="responsive_width">
                        ...
                        <a href="<?= isset($page_data[23]->link1_url) ? $page_data[23]->link1_url : '/home/listing' ?>"
                            ...
                            <i class="fa fa-angle-right"></i></a>
                        <a
                            href="<?= isset($page_data[23]->link2_url) ? $page_data[23]->link2_url : '/home/listing' ?>"><?= isset($page_data[23]->link2_label) ? $page_data[23]->link2_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin: 8px 0;">
            <div class="col-md-6 leftBox px-md-2">
                <div class="home_sections_bg5 div-sec similar_boxes" tabIndex=24 title="bg_img"
                    ...
                    <div style="margin: 0 auto" class="responsive_width">
                        ...
                        <a
                            href="<?= isset($page_data[24]->link1_url) ? $page_data[24]->link1_url : '/home/listing' ?>"><?= isset($page_data[24]->link1_label) ? $page_data[24]->link1_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                        <br>
                        <a
                            href="<?= isset($page_data[24]->link2_url) ? $page_data[24]->link2_url : '/home/listing' ?>"><?= isset($page_data[24]->link2_label) ? $page_data[24]->link2_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 rightBox px-md-2">
                <div class="home_sections_bg6 div-sec similar_boxes" tabIndex=25 title="bg_img"
                    ...
                    <div style="margin: 0 auto;" class="responsive_width">
                        <p><?= isset($page_data[25]->sub_heading) ? $page_data[25]->sub_heading : 'With a wide range of capabilities, iPad will change the way you work.' ?>
                        </p>
                        <a
                            href="<?= isset($page_data[25]->link1_url) ? $page_data[25]->link1_url : '/home/listing' ?>"><?= isset($page_data[25]->link1_label) ? $page_data[25]->link1_label : 'Learn More ' ?>
                            <i class="fa fa-angle-right"></i></a>
                        <br>
                        <a
                            href="<?= isset($page_data[25]->link2_url) ? $page_data[25]->link2_url : '/home/listing' ?>"><?= isset($page_data[25]->link2_label) ? $page_data[25]->link2_label : 'Buy ' ?>
                            <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
