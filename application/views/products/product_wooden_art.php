            ...
            <div class="container" style="max-width: 100vw; margin-left: 5px; margin-right: 5px">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 no-padding-mob">
                        ...
                        <!-- BOX 3 -->
                        <div id="apple_tv_feature_2" class="div-sec" tabIndex=5 title="bg_img"
                        ...
                        <div id="apple_tv_feature_3">
                            ...
                            <a
                                ...
                                <i class="fa fa-angle-right"></i></a>
                            <h2
                                style="margin-top: 30px;text-align: center;padding: 0 14px;background: -webkit-linear-gradient(#f0357c, #f154ff, #777dff, #497ce2, #37bdde);-webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                    ...
                    <div class="col-md-5 no-padding-mob">
                        ...
                        <div id="apple_tv_feature_3">
                            ...
                            <div class="row" style="margin-top: 50px;">
                                <div class="col-md-6">
                                    <div id="branding_1"
                                        style="background-image: url(<?= base_url((isset($page_data[4]->bg_img1) ? $page_data[4]->bg_img1 : 'assets/images/logo_samsung_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div id="branding_2"
                                        style="height: 40px !important; background-image: url(<?= base_url((isset($page_data[4]->bg_img2) ? $page_data[4]->bg_img2 : 'assets/images/logo_lg_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-md-6">
                                    <div id="branding_3"
                                        style="background-image: url(<?= base_url((isset($page_data[4]->bg_img3) ? $page_data[4]->bg_img3 : 'assets/images/logo_sony_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div id="branding_4"
                                        style="background-image: url(<?= base_url((isset($page_data[4]->bg_img4) ? $page_data[4]->bg_img4 : 'assets/images/logo_vizio_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5 no-padding-mob">
                        ...
                        <div id="apple_tv_feature_9">
                            ...
                            <div class="row" style="margin-top: 50px;">
                                ...
                                <div class="col-md-4">
                                    <div id="branding_6"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img2) ? $page_data[12]->bg_img2 : 'assets/images/logo_beats_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_7"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img3) ? $page_data[12]->bg_img3 : 'assets/images/logo_bluesound_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 30px;">
                                <div class="col-md-4">
                                    <div id="branding_8"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img4) ? $page_data[12]->bg_img4 : 'assets/images/logo_bose_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_9"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img5) ? $page_data[12]->bg_img5 : 'assets/images/logo_bowers_wilkins_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_10"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img6) ? $page_data[12]->bg_img6 : 'assets/images/logo_definitive_technology_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 30px;">
                                <div class="col-md-4">
                                    <div id="branding_11"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img7) ? $page_data[12]->bg_img7 : 'assets/images/logo_denon_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_12"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img8) ? $page_data[12]->bg_img8 : 'assets/images/logo_devialet_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_13"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img9) ? $page_data[12]->bg_img9 : 'assets/images/logo_dynaudio_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 30px;">
                                <div class="col-md-4">
                                    <div id="branding_14"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img10) ? $page_data[12]->bg_img10 : 'assets/images/logo_libratone_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_15"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img11) ? $page_data[12]->bg_img11 : 'assets/images/logo_marantz_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_16"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img12) ? $page_data[12]->bg_img12 : 'assets/images/logo_mcintosh_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 30px;">
                                <div class="col-md-4">
                                    <div id="branding_17"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img13) ? $page_data[12]->bg_img13 : 'assets/images/logo_naim_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_18"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img14) ? $page_data[12]->bg_img14 : 'assets/images/logo_polk_large.jpg')); ?>);">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div id="branding_19"
                                        style="background-image: url(<?= base_url((isset($page_data[12]->bg_img15) ? $page_data[12]->bg_img15 : 'assets/images/logo_sonos_large.jpg')); ?>);">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="apple_tv_feature_10"
                            style="background-image: url(<?= base_url((isset($page_data[14]->bg_img) ? $page_data[14]->bg_img : 'assets/images/anyone_can_add_songs_large.jpg')); ?>);">
                            <h3>
    ...
    <div class="container-fluid" style="margin: 0;padding: 0;">
        <div class="row" style="margin: 10px 0;">
            <div class="col-md-6 fullDiv_2" style="padding: 0;border-right: 13px solid #f7f7f7;">
                <div class="apple_tv_box_bg div-sec px-0 px-md-4 similar_boxes" tabIndex=19 title="bg_img"
            ...
            <div class="col-md-6 fullDiv_2" style="padding: 0;">
                <div class="apple_tv_box_bg_2 div-sec px-0 px-md-4 similar_boxes" tabIndex=20 title="bg_img"
        ...
        <div class="row" style="margin: 10px 0;">
            <div class="col-md-6 fullDiv_2" style="padding: 0;border-right: 13px solid #f7f7f7;">
                <div class="apple_tv_box_bg div-sec px-0 px-md-4 similar_boxes" tabIndex=21 title="bg_img"
                    ...
                    <div style="width: 600px;margin: 0 auto;" class="responsive_width">
                        ...
                        <a
                            href="<?= isset($page_data[21]->link1_url) ? $page_data[21]->link1_url : '/home/listing' ?>"><?= isset($page_data[21]->link1_label) ? $page_data[21]->link1_label : 'Learn more ' ?><i
                                class="fa fa-angle-right" aria-hidden="true"></i></a>
                        <a
            ...
            <div class="col-md-6 fullDiv_2" style="padding: 0;">
                <div class="apple_tv_box_bg_2 div-sec px-0 px-md-4 similar_boxes" tabIndex=22 title="bg_img"
