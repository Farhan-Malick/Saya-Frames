            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="text-align: center">
                        ...
                        <a href="<?= isset($page_data[23]->link1_url) ? $page_data[23]->link1_url : '/home/listing' ?>"><?= isset($page_data[23]->link1_label) ? $page_data[23]->link1_label : 'Find the one that’s right for you ' ?><i
