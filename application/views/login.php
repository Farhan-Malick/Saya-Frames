				...
				<div class="card mb-0">
					...
					<div class="tab-content card-body">
						<div class="tab-pane fade show active" id="login-tab1">
							<form class="login-form wmin-sm-400" method="post" action="<?= base_url() ?>login/verifyLogin">
								<div class="text-center mb-3">
									...
									<span class="d-block text-muted" style="color: red!important;">Incorrect
										Email/Password</span>
									<?php } ?>
								</div>
						...
						<div class="tab-pane fade" id="login-tab2">
							<form class="login-form wmin-sm-400 " id="register"  method="post" action="<?= base_url() ?>login/register">
								<div class="text-center mb-3">
									<i
