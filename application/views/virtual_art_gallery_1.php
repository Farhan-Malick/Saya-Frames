...
<div id="da-slider" class="da-slider" style="background-image: none;border: none;">
		<div class="da-slide" style="background-image: url(<?= base_url((isset($page_data[12]->bg_img1) ? $page_data[12]->bg_img1 : 'assets/images/tile_bg.jpg')); ?>);">
		...
		<div class="da-slide" style="background-image: url(<?= base_url((isset($page_data[12]->bg_img2) ? $page_data[12]->bg_img2 : 'assets/images/tile_bg.jpg')); ?>);">
		...
		<div class="da-slide" style="background-image: url(<?= base_url((isset($page_data[12]->bg_img3) ? $page_data[12]->bg_img3 : 'assets/images/tile_bg.jpg')); ?>);">
		...
		<div class="da-slide" style="background-image: url(<?= base_url((isset($page_data[12]->bg_img4) ? $page_data[12]->bg_img4 : 'assets/images/tile_bg.jpg')); ?>);">
...
<script type="text/javascript">
	$(function() {
		$('#da-slider').cslider({
			autoplay: <?= (isset($_SESSION['slider_session']) ? 'false' : 'true') ?>,
			current: <?= (isset($_SESSION['slider_session']) ? 4 : 0) ?>,
			bgincrement: 450
		});
	});
</script>