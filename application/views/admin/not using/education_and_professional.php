        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><span class="font-weight-semibold">What We Frame</span> - Educational And Professional</h4>
                            ...
                            <form action="#">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="section_text" placeholder="Section Text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <form action="#">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_1" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_2" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_3" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_4" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_5" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_6" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_7" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_8" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_9" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_10" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_11" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon_12" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="section_heading_2" placeholder="Section Heading 2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Link 1 Label:</label>
                            ...
                            <form action="#">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea class="form-control" name="left_side_text" placeholder="Left Side Text" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="text-right">
