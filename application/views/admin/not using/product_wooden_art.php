        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><span class="font-weight-semibold">Products</span> - Wooden Art</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="#">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img4" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img5" data-fouc>
										</div>
                                    </div>
                                </fieldset>
                                <div class="text-right">
                                    <button type="submit" name="submit_btn_4" class="btn btn-primary">Submit <i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                            ...
                            <form action="#">
                                ...
                                <div class="text-right">
                                    <button type="submit" name="submit_btn_6" class="btn btn-primary">Submit <i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                            <form action="#">
                                <fieldset>
                                ...
                                <div class="text-right">
                                    <button type="submit" name="submit_btn_5" class="btn btn-primary">Submit <i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                            ...
                            <form action="#">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="colorful_text" placeholder="Colorful Text">
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="text-right">
                            ...
                            <form action="#">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img6" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 7:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img7" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 8:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img8" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 9:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img9" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 10:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img10" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 11:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img11" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 12:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img12" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 13:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img13" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 14:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img14" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 15:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img15" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Small Text:</label>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img16" data-fouc>
										</div>
                                    </div>
                                </fieldset>
                                <div class="text-right">
