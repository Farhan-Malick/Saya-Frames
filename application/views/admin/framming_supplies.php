<?php
if($this->router->method == 'framming_supplies'){
    $page_title = 'Framing Supplies - Framing Supplies Main Page';
    $submit_btn_label = 'submit_btn_fs';
}else if($this->router->method == 'corporate_services'){
    $page_title = 'Services - Corporate Services';
    $submit_btn_label = 'submit_btn_cs';
}else if($this->router->method == 'mat_board'){
    $page_title = 'Framing Supplies - Mat Board';
    $submit_btn_label = 'submit_btn_mb';
}else if($this->router->method == 'glazing'){
    $page_title = 'Framing Supplies - Glazing';
    $submit_btn_label = 'submit_btn_fsg';
}
?>
<!-- Page content -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url() ?>save_in_db.php" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">Section Box 1</legend>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img" data-fouc>
                            ...
                            <form action="<?= base_url() ?>save_in_db.php" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">Section Box 2</legend>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img" data-fouc>
                            ...
                            <form action="<?= base_url() ?>save_in_db.php" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">Section Box 3</legend>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img3" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 3 Mobile:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img" data-fouc>
                                            <p class="form-text text-muted">
                                                Recommended Image Resolution : 
                            ...
                            <form action="<?= base_url() ?>save_in_db.php" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">Section Box 4</legend>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img" data-fouc>
                            ...
                            <form action="<?= base_url() ?>save_in_db.php" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">Section Box 5</legend>
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">Background Image 1:</label>
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="background_img1" data-fouc>
                            ...
                            <form action="<?= base_url() ?>save_in_db.php" method="post" enctype="multipart/form-data">
                                <fieldset>
                                    <legend class="font-weight-semibold text-uppercase font-size-sm">Fifth Section</legend>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Section Heading:</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="section_heading" placeholder="Section Heading">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon1_label" placeholder="Icon 1 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon2_label" placeholder="Icon 2 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon3_label" placeholder="Icon 3 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon4_label" placeholder="Icon 4 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon5_label" placeholder="Icon 5 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon6_label" placeholder="Icon 6 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon7_label" placeholder="Icon 7 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon8" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Icon 8 Label:</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon8_label" placeholder="Icon 8 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon9" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Icon 9 Label:</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon9_label" placeholder="Icon 9 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon10" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Icon 10 Label:</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon10_label" placeholder="Icon 10 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon12" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Icon 12 Label:</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon12_label" placeholder="Icon 12 Label">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" class="form-input-styled" accept="image/*" name="icon13" data-fouc>
										</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Icon 13 Label:</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="icon13_label" placeholder="Icon 13 Label">
                                        </div>
                                    </div>
